...
export const duckData = {
  0: {
    ...
    cry: require('../assets/sfx/duck-default.wav')
  },
  1: {
    name: 'Stabbo',
    species: 'Capybara',
    ...
    cry: require('../assets/sfx/capybara-default.wav')
  },
  2: {
    name: 'Rizzy',
    species: 'Duck',
  ...
  5: {
    ...
    cry: require('../assets/sfx/crowbro/crow-default.wav')
  },
  6: {
    name: 'Squiddy',
    species: 'Squid',
    ...
    cry: require('../assets/sfx/squiddy/octo.mp3')
  },
};
